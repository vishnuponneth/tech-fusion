  ...
  return (
    <>
      ...
      <div class="container">
        ...
        <div class="section">
          <h2 class="section-title">Welcome to Tech Fusion</h2>
          <p>Your gateway to advanced learning and skill development!</p>
          <p>At Tech Fusion, we are dedicated to bridging the gap between traditional education and industry needs by offering specialized online tuition and internships for BTech students. Our goal is to empower the next generation of engineers with the knowledge and practical skills necessary to excel in both their academic and professional careers.</p>
        </div>

        <div class="section">
          <h2 class="section-title">Who We Are</h2>
          <p>Tech Fusion is an innovative online platform designed to provide high-quality education and hands-on training in various BTech subjects and technologies. With a focus on delivering both theoretical understanding and real-world application, we help students master their subjects and enhance their technical expertise.</p>
        </div>
        ...
        <div class="section">
          ...
          <p>We aim to become a leading online platform for BTech students and aspiring engineers, recognized for excellence in education, training, and skill development. As we continue to expand, our goal is to offer a diverse range of courses and internships in the latest technological fields, keeping pace with the evolving demands of the industry.</p>
          <p>At Tech Fusion, we are committed to shaping the engineers of tomorrow by offering an education that goes beyond textbooks. Join us on this journey of learning, innovation, and success.</p>
        </div>
      </div>
    </>
  );
